...
export async function POST(request: NextRequest) {
  try {
    ...
    // Constructed here rather than inside the stream: a missing API key throws, and
    // inside the stream that would reset the connection instead of returning an error.
